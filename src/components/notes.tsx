...
export default function NotesApp() {
  ...
  return (
    <div className="flex flex-col h-screen bg-background text-foreground bg-zinc-200">
      <header className=" p-4 shadow bg-pink-700">
        <h1 className="text-2xl font-bold text-slate-50">Note Taker</h1>
      </header>
      <main className="flex-1 overflow-auto p-4">
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full rounded-md border border-input bg-background p-2 text-foreground focus:outline-none focus:ring-1 focus:ring-primary  text-slate-800"
          />
          ...
          {notes.map((note) => (
            <Card key={note.id} className="p-4">
              <div className="flex items-center justify-between">
                <u><h2 className="text-lg font-bold text-blue-800 ">{note.title}</h2></u>
